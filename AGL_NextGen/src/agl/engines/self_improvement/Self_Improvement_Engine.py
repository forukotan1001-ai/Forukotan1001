...
_SELF_LEARN_ENABLED = os.getenv("AGL_SELF_LEARNING_ENABLE", "0").strip() == "1"
_SELF_LEARN_MODE = os.getenv("AGL_SELF_LEARNING_MODE", "offline").strip() or "offline"
_SELF_LEARN_DIR = os.getenv("AGL_SELF_LEARNING_LOGDIR", "").strip()
