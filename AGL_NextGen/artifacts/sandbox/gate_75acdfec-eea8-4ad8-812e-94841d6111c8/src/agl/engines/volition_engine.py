...
try:
    # Prefer NextGen hosted LLM shim (stable path inside AGL_NextGen)
    from agl.lib.llm.hosted_llm import chat_llm as _chat_llm
    ...
    # Fallback to legacy Core_Engines if present
    from Core_Engines.Hosted_LLM import HostedLLM  # type: ignore
