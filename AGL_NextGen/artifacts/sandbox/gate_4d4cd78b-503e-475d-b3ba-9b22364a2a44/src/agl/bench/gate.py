...
def run_gate_once(config: GateConfig) -> Dict[str, Any]:
    ...
    baseline = {
        "suite": config.suite,
        "summary": _run_bench_summary(base_root, config.suite, effective_repeats, config.use_core_consciousness),
        "regressions": {},
    }
    ...
    after = {
        "suite": config.suite,
        "summary": _run_bench_summary(sandbox_root, config.suite, effective_repeats, config.use_core_consciousness),
        "regressions": {},
    }
    for s in regression_suites:
