...
try:
    ...
    sys.path.append(os.path.join(root_dir, "GENESIS_OMEGA"))
    from GENESIS_OMEGA_CORE import GENESIS_OMEGA_Entity, AGL_Super_Intelligence

# Import Advanced Engines for Training
try:
    from Core_Engines.Creative_Innovation import CreativeInnovation
    from Core_Engines.AdvancedMetaReasoner import AdvancedMetaReasonerEngine
    ...
    from AGL_Core.AGL_Dormant_Powers import NeuralResonanceBridge
