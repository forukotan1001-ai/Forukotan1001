...
## 📘 Introduction
Cette application Angular permet la gestion du transport des collaborateurs.  
...
3. Faire un **Pull Request** en respectant les conventions de commit

---

## 📜 Licence

Projet interne – usage restreint selon les conditions de l’entreprise.

```

---

👉 Je peux aussi te préparer une version **PDF bien formatée** (style cahier technique), si tu veux un document plus formel à partager.  

Veux-tu que je te prépare en plus la **version PDF** avec une mise en page professionnelle (logos, table des matières, etc.) ?
```
